...
class ItemContentHashtagAdapter : ListAdapter<HashTagData, ItemContentHashtagAdapter.ItemContentHashtagViewHolder>(
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ItemContentHashtagViewHolder {
        val binding = ItemContentHashtagBinding.inflate(LayoutInflater.from(parent.context),parent,false)
