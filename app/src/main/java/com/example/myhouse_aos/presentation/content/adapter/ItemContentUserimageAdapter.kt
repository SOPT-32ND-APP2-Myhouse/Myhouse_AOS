...
class ItemContentUserimageAdapter : ListAdapter<UserimageData, ItemContentUserimageAdapter.ItemContentUserimageViewHolder>(
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ItemContentUserimageViewHolder {
        val binding = ItemContentUserimageBinding.inflate(LayoutInflater.from(parent.context),parent,false)
