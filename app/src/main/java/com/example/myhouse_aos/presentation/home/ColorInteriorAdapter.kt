...
class ColorInteriorAdapter : ListAdapter<ContentsData, ColorInteriorAdapter.ContentViewHolder>(
    ...
    class ContentViewHolder(
        private val binding: ItemColorInteriorBinding,
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ContentViewHolder {
        val binding =
            ItemColorInteriorBinding.inflate(LayoutInflater.from(parent.context), parent, false)
